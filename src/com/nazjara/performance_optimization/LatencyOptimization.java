package com.nazjara.performance_optimization;
...
public class LatencyOptimization {
    public static final String SOURCE_FILE = "./resources/old.jpg";
    public static final String DESTINATION_FILE = "./resources/new.jpg";
